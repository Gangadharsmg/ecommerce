...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			<marquee>  <a href="index.php"><h1>E-commerce <span></span></h1> </a></marquee>
		  </div>
		...
		<ul class="megamenu skyblue">
			...
			<li><a class="color6" href="headphone.php"><b>HEADPHONE</b></a></li>			
			<li><a class="color8" href="tshirt.php"><b>T-SHIRT</a></b></li>
			<li><a class="color9" href="watches.php"><b>WATCHES</a></b></li>
            <li></li>
			</li>	
		 </ul>
	</div>
